...
if (!isset($_POST['confirm']) || !$_POST['confirm']) {
	...
	/*
	$regPhp="<iframe src='https://www.carocrm.com/product-registration/
...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
	...
	<th width="200" style="text-align: right;"><a href="http://www.carocrm.com" target="_blank"><IMG src="$loginImage" alt="CaroCRM" border="0"></a></th>
</tr>
<tr>
