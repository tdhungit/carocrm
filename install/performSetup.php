...
$setup_site_log_file                = 'carocrm.log';  // may be an option later
...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      <th width="500">
		<p>
		<img src="{$sugar_md}" alt="CaroCRM" border="0">
		</p>
		{$mod_strings['LBL_PERFORM_TITLE']}</th>
    <th width="200" style="text-align: right;"><a href="http://www.carocrm.com" target="_blank">
    <IMG src="$loginImage" alt="CaroCRM" border="0"></a></th>
</tr>
<tr>
   <td colspan="2">
EOQ;
...
$errTcpip = '';
    $fp = @fsockopen("www.carocrm.com", 80, $errno, $errstr, 3);
    if (!$fp) {
...
FP;
    ...
    $enabled_tabs[] = 'UA_Products';
    $enabled_tabs[] = 'UA_ProductCategories';
    $enabled_tabs[] = 'UA_Manufacturers';
    $enabled_tabs[] = 'UA_Contracts';
    $enabled_tabs[] = 'UA_Quotes';
