...
<head>
   ...
   <link REL="SHORTCUT ICON" HREF="include/images/CaroCRM_icon.ico">
...
<form action="welcome.php" method="post" name="setLang" id="langForm">
  <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      ...
      <th width="200" height="30" style="text-align: right;"><a href="http://www.carocrm.com" target="_blank">
      	<IMG src="include/images/carocrm_login.png" alt="CaroCRM" border="0"></a>
      </th>
    </tr>
    <tr>
      <td colspan="2">
