...
////    BEGIN PAGE OUTPUT
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    <tr>
      ...
      <th width="200" height="30" style="text-align: right;"><a href="http://www.carocrm.com" target=
      "_blank"><IMG src="include/images/carocrm_login.png" alt="CaroCRM" border="0"></a>
    ...
    <tr>
      <td align="right" colspan="2">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
          <tr>
            <td><input class="button" type="button" onclick="window.open('http://www.carocrm.com/forums/');" value="{$mod_strings['LBL_HELP']}" /></td>
            <td>
